            ...
            <div className="flex mt-4 justify-center lg:justify-start">
              <motion.button
                ...
                style={{
                  ...
                  border: "none",
                  cursor: "pointer",
                  backgroundClip: "text", // Apply text gradient effect
                }}
                onClick={() => window.open(PROJECTS.site, "_blank")}
              >
                <span className="bg-gradient-to-r from-blue-700 via-puple-500 to-yellow-400 bg-clip-text tracking-tight text-transparent ">
                  {" "}
                  Visit site{" "}
                </span>
              </motion.button>
              <motion.button
                ...
                onClick={() => window.open(PROJECTS.git, "_blank")}
              >
